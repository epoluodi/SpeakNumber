...
- (void)positionAndUpdatePopUpView
{
    ...
    if (![self.dataSource respondsToSelector:@selector(slider:stringForValue:)])
    {
...
- (void)autoColorTrack
{
    ...
    [self setThumbTintColor:[self.popUpView opaqueColor]];
    [self.dataSource getslikerOpaqueColor:[self.popUpView opaqueColor] this:self];
    super.minimumTrackTintColor = [self.popUpView opaqueColor];
}
